          ...
          <div class="panel-body"> 
            <form action="/pesanan/create" method="POST">
              ...
              <div class="form-group">
                ...
                <input name="nama" type="text" class="form-control" id="namaPemesan" placeholder="Pemesan">
              </div>
              <div class="form-group">
                <label for="tempatPemesan">Tempat</label>
                <input name="tempat" type="text" class="form-control" id="tempatPemesan" placeholder="Tempat">
              </div>
              <div class="form-group">
                <table class="table table-condensed">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                       <select  name="jumlah" id="jumlah{{$makanan->id}}" class="form-control">
                    ...
                    <td>
                      <input @change="pushId({{$makanan->id}}), pushJumlah( document.getElementById('jumlah{{$makanan->id}}'))" name="beli[]" value="{{$makanan->id}}" class="form-check-input" type="checkbox" id="cd{{$makanan->id}}">
                  ...
                  <td>
                    <input @change="pushIdMinuman({{$minuman->id}}), pushJumlahMinuman( document.getElementById('jumlahM{{$minuman->id}}'))" name="beli1[]" value="{{$minuman->id}}" class="form-check-input" type="checkbox" id="cdm{{$minuman->id}}">
